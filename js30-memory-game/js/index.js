...
7. Очень высокое качество оформления приложения и/или дополнительный не предусмотренный в задании функционал, улучшающий качество приложения +10
	- звуковое сопровождение для: переворота карточки, для совпадающих карточек и завершения игры
	- кнопка отключения/включения звуков в игре
	- сортировка результатов в таблице рекордов не только по количеству шагов, но и по длительности игры
	`);
}